package stack_and_queue.lc0232_implement_queue_using_stacks;
...
public class MyQueue1<E> {
    /**
     * The main stack_and_queue for storing elements
     */
    private Stack<E> s1;
    /**
     * The auxiliary stack_and_queue for adjusting the order of elements
     */
    private Stack<E> s2;
