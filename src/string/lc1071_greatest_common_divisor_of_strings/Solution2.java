package string.lc1071_greatest_common_divisor_of_strings;
...
public class Solution2 {
    /**
     * Approach 2: Compare prefix string of length `gcd(l1, l2)` is both n times concatenations of str1 and str2
     ...
     * Memory Usage: 38.5 MB, less than 100.00% of Java online submissions for Greatest Common Divisor of Strings.
     *
    ...
    public String gcdOfStrings(String str1, String str2) {
        ...
        String prefix = str1.substring(0, gcd(l1, l2));
        return isNTimes(prefix, str1) && isNTimes(prefix, str2) ? prefix : "";
    }
